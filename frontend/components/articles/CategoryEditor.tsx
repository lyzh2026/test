...
export function CategoryEditor({
  ...
  return (
    <div className="rounded-[12px] p-4" style={{ background: '#181b25' }}>
      <div className="mb-2 flex items-center gap-2">
        <h2 className="text-xs font-semibold uppercase tracking-wider" style={{ color: '#6b6d7b' }}>AI 分类</h2>
      ...
      <div className="mt-3 flex items-center gap-3">
        ...
        {error && <span className="text-xs" style={{ color: '#e45a5a' }}>{error}</span>}
      </div>
    </div>
  );
}
